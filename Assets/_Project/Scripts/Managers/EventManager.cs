...
public class EventManager : MonoBehaviour
{
    ...
    public void StartListening<T>(EventDelegate<T> del) where T : GameEvent
    {
        AddDelegate<T>(del);
    }

    public void StartListeningOnce<T>(EventDelegate<T> del) where T : GameEvent
    {
    ...
    public void StopListening<T>(EventDelegate<T> del) where T : GameEvent
    {
